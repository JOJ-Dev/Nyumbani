# Generated by Django 5.0.7 on 2025-05-12 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Appartment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.appartment')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DeadlineOfPayment', models.DateField()),
                ('rentBalance', models.CharField(max_length=200)),
                ('PaidAmount', models.CharField(max_length=200)),
                ('Appartment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.appartment')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
